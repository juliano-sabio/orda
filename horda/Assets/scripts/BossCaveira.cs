...
public class BossCaveira : MonoBehaviour, IBoss, IBossHud
{
    ...
    {
        SomCoop(SomSkill.Tipo.CaveiraFase2, transform.position, 0.8f);
    ...
    IEnumerator Emboscar()
    {
        ...
        // Reaparece
        SomCoop(SomSkill.Tipo.CaveiraEmboscada, transform.position, 0.65f);
    ...
    IEnumerator Investida()
    {
        ...
        SomCoop(SomSkill.Tipo.CaveiraInvestida, transform.position, 0.65f);
    ...
    IEnumerator GritoSonico()
    {
        ...
        SomCoop(SomSkill.Tipo.CaveiraGrito, transform.position, 0.75f);
    ...
    IEnumerator GarrasDasSombras()
    {
        ...
        SomCoop(SomSkill.Tipo.CaveiraGarras, alvo, 0.7f);
    ...
    void Disparar()
    {
        ...
        SomCoop(SomSkill.Tipo.CaveiraDisparo, PosicaoBoca(), 0.55f);
